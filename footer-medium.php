...
<footer class="footer">
    <div class="container">
        ...
        <div class="footer__cookies">
            <a href="<?php echo get_permalink( get_page_by_path( 'polityka-prywatnosci' ) ); ?>">Polityka prywatności</a>
        </div>
        ...
        <div class="footer__bottom">
            ...
            <span class="footer__project">Projekt i realizacja : <a href="http://propercolors.pl/" target="_blank">www.propercolors.pl</a></span>
        </div>
    </div>
</footer>
