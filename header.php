    ...
    <header class="header">
        ...
        <div class="container">
            <div class="header__wrapper">
                <div class="heade__left" data-scroll="fadeIn">
                    <a class="header__logo" data-fade="true" href="<?php echo home_url(); ?>"><?php get_template_part('img/svg/logo.svg'); ?></a>
                </div>
                ...
                <div class="header__right" data-scroll="fadeIn">
                    ...
                    <div class="header__close">
                        <a class="menu__cart cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'blank' ); ?>">
                            <?php get_template_part('img/svg/cart.svg'); ?><span class="menu-cart__number"><?php echo WC()->cart->get_cart_contents_count() ?></span>
                        </a>
