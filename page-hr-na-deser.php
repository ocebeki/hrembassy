    ...
    <div class="klienci__wrapper">
      ...
      <div class="klienci__slider" data-slider="klienci" data-scroll="staggerUp">
        ...
        <div class="klienci__item" data-scroll="staggerUpItem">
          <a class="klienci__link" href="<?php the_sub_field('link'); ?>"><img src="<?php the_sub_field('logo'); ?>"
              alt="" /></a>
        </div>
        <?php endwhile; ?>
      </div>
        ...
        <div class="single-product__content">
          <div class="row">
            ...
            <div class="col-md-8 program__line">
              ...
              <div class="program__item <?php if (get_sub_field('program_ikona') != 'brak') { echo 'ikona'; } ?>"
                data-scroll="fadeUp">
    ...
    <div class="zostan__wrapper">
      <div class="zostan__left">
        <div>
          ...
          <div class="prelegentem" data-scroll="fadeIn">
            <?php echo do_shortcode('[contact-form-7 id="375" title="Zostań prelegentem"]'); ?></div>
        </div>
      </div>
...
document.addEventListener('wpcf7mailsent', function(event) {
  if (event.detail.contactFormId == '380') {
    location = '<?php echo get_permalink(get_page_by_path('
    thank - you ')); ?>';
  }
}, false);
</script>
