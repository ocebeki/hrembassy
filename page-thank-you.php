            ...
            <div class="sekcja__wrapper">
                <div class="sekcja__left">
                    <div>
                        ...
                        <div class="sekcja__text" data-scroll="fadeUp">po weryfikacji zgłoszenia dostaniesz od nas potwierdzenie udziału w wydarzeniu lub zapis na listę rezerwową.</div>
                        ...
                        <a class="btn btn--thankyou" href="<?php the_field('fb_link'); ?>" data-scroll="fadeIn" target="_blank">Dołącz do wydarzenia na Facebook'u</a>
                    </div>
                </div>
