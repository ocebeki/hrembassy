<?php get_header(); ?>
        ...
        <div class="container">
            <div class="warsztaty-menu__wrapper">
                ...
                <div class="warsztaty-menu__part-wrapper">
                    <div class="warsztaty-menu__part" data-scroll="fadeLeft"><a class="warsztaty-menu__link" href="<?php echo get_permalink( get_page_by_path( 'warsztaty' ) ); ?>" >Warsztaty</a></div>
                    <div class="warsztaty-menu__part" data-scroll="fadeRight"><span class="warsztaty-menu__link warsztaty-menu__link--active">Warsztaty dedykowane</span></div>
                </div>
                        ...
                        <span class="klienci__link klienci__btn">
                            ...
                            <div class="klienci__case-study">
                                <div class="klienci__popup-left">
                                    <div class="klienci__popup-img"><img src="<?php the_sub_field('klienci_popup_img_left'); ?>" alt="" /></div>
                                ...
                                <div class="klienci__popup-middle">
                                    <div class="klienci__popup-img"><img src="<?php the_sub_field('klienci_popup_img_middle'); ?>" alt="" /></div>
                                ...
                                <div class="klienci__popup-right">
                                    <div class="klienci__popup-img"><img src="<?php the_sub_field('klienci_popup_img_right'); ?>" alt="" /></div>
    ...
    <div class="klienci__popup">
        <div>
            <div class="klienci__popup-close"><span data-kpop="close"><?php get_template_part('img/svg/close.svg'); ?></span></div>
