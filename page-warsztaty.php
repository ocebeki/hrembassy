        ...
        <div class="container">
            <div class="warsztaty-menu__wrapper">
                ...
                <div class="warsztaty-menu__part-wrapper">
                    <div class="warsztaty-menu__part" data-scroll="fadeLeft"><span class="warsztaty-menu__link warsztaty-menu__link--active" >Warsztaty</span></div>
                    <div class="warsztaty-menu__part" data-scroll="fadeRight"><a class="warsztaty-menu__link" href="<?php echo get_permalink( get_page_by_path( 'warsztaty-dedykowane' ) ); ?>">Warsztaty dedykowane</a></div>
                </div>
        ...
        <div class="container">
            <div class="baner-dedykowane__wrapper">
                ...
                <div class="baner-dedykowane__middle">
                    ...
                    <a class="btn" href="<?php echo get_permalink(get_page_by_path('warsztaty-dedykowane')); ?>" data-scroll="fadeIn">Zobacz więcej</a>
                </div>
                ...
                <div class="gdzie__right">
                    <div>
                        ...
                        <div class="gdzie_place" data-scroll="staggerUp">
                            ...
                            <div class="gdzie__place-adres" data-scroll="staggerUpItem">Dopasujemy miejsce do Twoich potrzeb</div>
                        </div>
                    </div>
                </div>
            </div>
