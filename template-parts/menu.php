<ul class="menu" data-scroll="staggerUp">
    <li class="menu__item" data-scroll="staggerUpItem">
    ...
    <li class="menu__item" data-scroll="staggerUpItem">
        <!-- <a class="menu__link" href="<?php echo get_permalink(get_page_by_path('i-love-hr')); ?>">I love HR</a> -->
