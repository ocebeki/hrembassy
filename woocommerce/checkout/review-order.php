...
?>
<table class="shop_table zamowienie__table woocommerce-checkout-review-order-table">
	<thead>
		<tr>
			<th>Warsztat</th>
			<th class="left">Cena</th>
		</tr>
	</thead>
	<tbody>
		<?php
	...
	<tfoot>
		...
		<?php foreach ( WC()->cart->get_coupons() as $code => $coupon ) : ?>
			<tr class="cart-discount coupon-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
				...
				<td class="left"><?php wc_cart_totals_coupon_html( $coupon ); ?></td>
			</tr>
		<?php endforeach; ?>
...
//                wc_cart_totals_shipping_html(); 
		...
		<?php foreach ( WC()->cart->get_fees() as $fee ) : ?>
			<tr class="fee">
				...
				<td class="left"><?php wc_cart_totals_fee_html( $fee ); ?></td>
			</tr>
		<?php endforeach; ?>
			...
			<?php if ( 'itemized' === get_option( 'woocommerce_tax_total_display' ) ) : ?>
				<?php foreach ( WC()->cart->get_tax_totals() as $code => $tax ) : ?>
					<tr class="tax-rate tax-rate-<?php echo sanitize_title( $code ); ?>">
						...
						<td class="left"><?php echo wp_kses_post( $tax->formatted_amount ); ?></td>
					</tr>
				<?php endforeach; ?>
			<?php else : ?>
				<tr class="tax-total">
					<td><?php echo esc_html( WC()->countries->tax_or_vat() ); ?></td>
					<td class="left"><?php wc_cart_totals_taxes_total_html(); ?></td>
				</tr>
			<?php endif; ?>
		<?php endif; ?>
		...
		<tr class="order-total">
			...
			<td class="left"><?php wc_cart_totals_order_total_html(); ?></td>
		</tr>
