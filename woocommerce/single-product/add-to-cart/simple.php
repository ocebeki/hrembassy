...
if ( $product->is_in_stock() ) : ?>
	...
	<form class="cart" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype='multipart/form-data'>
        ...
        <div class="product__price-wrapper">
            <div class="product__price-left">
                <div class="sklep__price">
                    <div class="sklep__price-new">
                        <strong>
                            <?php echo get_post_meta( get_the_ID(), '_price', true); ?>
                        </strong>
                    </div>
                    <div>
                        <strong class="sklep__price-new-small">zł netto</strong> / <span>osoba</span>
                    </div>  
                </div>
            </div>
        ...
        <div class="product__button">
            <button type="submit" name="add-to-cart" value="<?php echo esc_attr($product->get_id()); ?>" class="btn btn--wide alt" id="buy_now_button">
                <?php echo esc_html('Zapisz się'); ?>
            </button>
