		...
		<div class="variations">
				<?php foreach ( $attributes as $name => $options ) : ?>
					...
					<div class="attribute-<?php echo esc_attr( $sanitized_name ); ?>">
						<div class="variations__heading"><label for="<?php echo esc_attr( $sanitized_name ); ?>"><?php echo wc_attribute_label( $name ); ?></label></div>
						<?php
						...
						?>
						<div class="variations__wrapper value">
							<?php
							if ( ! empty( $options ) ) {
